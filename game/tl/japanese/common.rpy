...
translate japanese strings:
    ...
    new "本プログラムは、MIT License や GNU Lesser General Public License など、様々なライセンスのフリーウェアを含んでいます。 フルソースコードへのリンクを含む、完全なソフトウェアのリストは、{a=https://www.renpy.org/l/license}こちら{/a}です。"
...
# TODO: Translation updated at 2026-01-04 10:06
...
translate japanese strings:
    ...
    new " の翻訳： [tl.filename]:[tl.linenumber]"

    # renpy/common/00translation.rpy:101
    old "\n{color=#fff}Copied to clipboard.{/color}"
    new "\n{color=#fff}クリップボードにコピーしました。{/color}"
    ...
    new "ANGLE2 Rendererを強制"

    # renpy/common/00gltest.rpy:106
    old "Force GLES2 Renderer"
    new "GLES2 Rendererを強制"
    ...
    new "このゲームでは初期化できないGL2を使用する必要があります。"

    # renpy/common/00gltest.rpy:216
    old "This computer has a problem displaying graphics: [problem]."
    new "コンピューター上でグラフィックの表示に問題が生じています：[problem]"

    # renpy/common/00gltest.rpy:220
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "グラフィックドライバーが最新の状態ではないか、正しく動作していない可能性があります。これにより、グラフィックの表示が遅くなったり、正しく表示されない場合があります。"

    # renpy/common/00gltest.rpy:224
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "{a=edit:1:log.txt}log.txt{/a} にコンピューターの問題を特定する情報が含まれている場合があります。"

    # renpy/common/00gltest.rpy:229
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "問題解決のための詳細は{a=[url]}ドキュメント{/a}で確認できます。"
    ...
    new " [name] を調整中 ([i]/[total])"

    # renpy/common/00gamepad.rpy:60
    old "Press or move the '[control!s]' [kind]."
    new "'[control!s]' [kind]を押すまたは動かす。"
    ...
    new "traceback.txt をテキストエディターで開きます。"
    ...
    new "traceback.txt を、BBCodeとしてクリップボードにコピーします（https://lemmasoft.renai.us/ などのフォーラム用）。"
    ...
    new "traceback.txt をマークダウンでクリップボードにコピーします（Discord用）。"
    ...
    new "前の時点へのロールバックを試み、セーブまたは別の選択肢を選べるようにします。"
    ...
    new "例外を無視して、続行します。追加のエラーが発生する可能性が高くなります。"
    ...
    new "ディスクからゲームをリロードし、可能な場合はゲームをセーブおよび復元します。"
