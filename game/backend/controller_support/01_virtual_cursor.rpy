...
python early:
    ...
    class VirtualCursor(renpy.display.layout.MultiBox, StickEvent):
        ...
        def get_mouse_name(self):
            ...
            if mouse_kind.startswith("pressed_") and ("pressed_default" in self.cursors): 
                
                mouse_kind = "pressed_default"
            elif mouse_kind.startswith("pressed_") and (mouse_kind[8:] in self.cursors): 
