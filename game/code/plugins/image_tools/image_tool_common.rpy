...
style sprt_copy_button_text is sprt_text:
...
style sprt_small_button:
    ...
    align (0.5, 0.5)
style sprt_small_button_text is sprt_text:
...
style sprt_small_label:
    background None
style sprt_small_label_text is sprt_text


style sprt_zoom_vbox:
    align (0.0, 1.0) xoffset sprt.SPACER
style sprt_zoom_text is sprt_text:
...
style sprt_zoom_hbox:
    xmaximum config.screen_width-int(config.screen_width/2.2)-100
    spacing sprt.PADDING*3
style sprt_zoom_button is sprt_small_button

style sprt_zoom_button_text is sprt_small_button_text
...
style hamburger_button_text is sprt_text:
...
style sprt_drag_text is sprt_text:

    xalign 1.0 yalign 0.5
    outlines [(1, "#000")]
style sprt_drag_hbox:
    spacing sprt.PADDING*3 yalign 0.5
style sprt_drag_button is sprt_small_button:
...
style sprt_drag_button_text is sprt_small_button_text
...
style sprt_input_button:
    ...
    xsize sprt.SPACER*7
    padding (sprt.PADDING*2, sprt.PADDING*2)
style sprt_input_button_text is sprt_text:

    align (0.5, 0.5)
style sprt_input_input is sprt_text:

    align (0.5, 0.5)
    color "#000"

style sprt_drop_frame is sprt_small_frame:
...
style sprt_drop_button is sprt_small_button:

    size_group 'tag_drop' xmaximum sprt.SPACER*16
style sprt_drop_button_text is sprt_small_button_text
...
style sprt_tut_label:
    padding (sprt.PADDING*2, sprt.PADDING*2)
    align (0.5, 0.5)
style sprt_tut_label_text is sprt_text:
    ...
    color sprt.YELLOW
    layout "subtitle"
style sprt_hyperlink_text is sprt_text:

    color sprt.RED hover_color sprt.ORANGE
    hover_underline True
style sprt_tut_text is sprt_text:
...
style image_tools_button:
    ...
    padding (sprt.SPACER, sprt.SPACER)
style image_tools_button_text is sprt_text:
