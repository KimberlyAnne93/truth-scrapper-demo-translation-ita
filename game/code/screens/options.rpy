...
define config.name = _("Truth Scrapper Demo")
...
define build.name = "TruthScrapperDemo"
...
define config.main_menu_music = "music/00 Bossa de Sosotte.wav"
...
define config.save_directory = "TruthScrapperDemo-1690232036"
